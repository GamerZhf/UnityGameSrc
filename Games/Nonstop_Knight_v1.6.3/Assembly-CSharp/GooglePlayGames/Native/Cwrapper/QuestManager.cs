namespace GooglePlayGames.Native.Cwrapper
{
    ...
    internal static class QuestManager
    {
        ...
        [DllImport("gpg")]
        internal static extern GooglePlayGames.Native.Cwrapper.CommonErrorStatus.QuestAcceptStatus QuestManager_AcceptResponse_GetStatus(HandleRef self);
        [DllImport("gpg")]
        ...
        [DllImport("gpg")]
        internal static extern GooglePlayGames.Native.Cwrapper.CommonErrorStatus.QuestClaimMilestoneStatus QuestManager_ClaimMilestoneResponse_GetStatus(HandleRef self);
        [DllImport("gpg")]
        ...
        [DllImport("gpg")]
        internal static extern GooglePlayGames.Native.Cwrapper.CommonErrorStatus.ResponseStatus QuestManager_FetchListResponse_GetStatus(HandleRef self);
        [DllImport("gpg")]
        ...
        [DllImport("gpg")]
        internal static extern GooglePlayGames.Native.Cwrapper.CommonErrorStatus.ResponseStatus QuestManager_FetchResponse_GetStatus(HandleRef self);
        [DllImport("gpg")]
        ...
        [DllImport("gpg")]
        internal static extern GooglePlayGames.Native.Cwrapper.CommonErrorStatus.UIStatus QuestManager_QuestUIResponse_GetStatus(HandleRef self);
        [DllImport("gpg")]
