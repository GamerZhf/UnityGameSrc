namespace GooglePlayGames.Native.PInvoke
{
    ...
    internal class TurnBasedManager
    {
        ...
        {
            return Callbacks.ToIntPtr<TurnBasedMatchResponse>(callback, new Func<IntPtr, TurnBasedMatchResponse>(TurnBasedMatchResponse.FromPointer));
        }
        ...
        internal class TurnBasedMatchesResponse : BaseReferenceHolder
        {
            ...
            {
                return PInvokeUtilities.ToEnumerable<NativeTurnBasedMatch>(TurnBasedMultiplayerManager.TurnBasedMultiplayerManager_TurnBasedMatchesResponse_GetCompletedMatches_Length(base.SelfPtr()), delegate (UIntPtr index) {
                    return new NativeTurnBasedMatch(TurnBasedMultiplayerManager.TurnBasedMultiplayerManager_TurnBasedMatchesResponse_GetCompletedMatches_GetElement(base.SelfPtr(), index));
                });
            }
