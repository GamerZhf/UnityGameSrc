...
[RequireComponent(typeof(Text)), AddComponentMenu("UI/ToJ Effects/Curve Effect", 6)]
public class CurveEffect : BaseVertexEffect
{
    [SerializeField]
    private bool m_CenterOnCurveHalfPoint;
    [SerializeField]
    private bool m_CharacterCountScalesStrength;
    [SerializeField]
