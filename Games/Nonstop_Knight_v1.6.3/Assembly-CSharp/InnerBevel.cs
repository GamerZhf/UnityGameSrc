...
[DisallowMultipleComponent, RequireComponent(typeof(Text)), AddComponentMenu("UI/ToJ Effects/Inner Bevel", 0x13)]
public class InnerBevel : BaseVertexEffect, IMaterialModifier
{
    ...
    public virtual Material GetModifiedMaterial(Material baseMaterial)
    {
        ...
        material2.name = baseMaterial.name + " with IB";
    ...
    public ColorMode highlightColorMode
    {
        get
        {
            return this.m_HighlightColorMode;
        }
        set
        {
