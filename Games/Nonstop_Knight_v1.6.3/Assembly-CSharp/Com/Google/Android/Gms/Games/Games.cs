namespace Com.Google.Android.Gms.Games
{
    ...
    public class Games : JavaObjWrapper
    {
        ...
        {
            object[] args = new object[] { arg_GoogleApiClient_1 };
            return JavaObjWrapper.StaticInvokeCall<string>("com/google/android/gms/games/Games", "getCurrentAccountName", "(Lcom/google/android/gms/common/api/GoogleApiClient;)Ljava/lang/String;", args);
        }

        public static int getSdkVariant(GoogleApiClient arg_GoogleApiClient_1)
        {
            object[] args = new object[] { arg_GoogleApiClient_1 };
            return JavaObjWrapper.StaticInvokeCall<int>("com/google/android/gms/games/Games", "getSdkVariant", "(Lcom/google/android/gms/common/api/GoogleApiClient;)I", args);
        }

        public static object getSettingsIntent(GoogleApiClient arg_GoogleApiClient_1)
        {
            object[] args = new object[] { arg_GoogleApiClient_1 };
            return JavaObjWrapper.StaticInvokeCall<object>("com/google/android/gms/games/Games", "getSettingsIntent", "(Lcom/google/android/gms/common/api/GoogleApiClient;)Landroid/content/Intent;", args);
        }

        public static void setGravityForPopups(GoogleApiClient arg_GoogleApiClient_1, int arg_int_2)
        {
            object[] args = new object[] { arg_GoogleApiClient_1, arg_int_2 };
            JavaObjWrapper.StaticInvokeCallVoid("com/google/android/gms/games/Games", "setGravityForPopups", "(Lcom/google/android/gms/common/api/GoogleApiClient;I)V", args);
        }
        ...
        {
            object[] args = new object[] { arg_GoogleApiClient_1 };
            return JavaObjWrapper.StaticInvokeCall<PendingResult<Status>>("com/google/android/gms/games/Games", "signOut", "(Lcom/google/android/gms/common/api/GoogleApiClient;)Lcom/google/android/gms/common/api/PendingResult;", args);
        }
