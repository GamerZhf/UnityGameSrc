namespace PlayerView
{
    ...
    public class ItemListContent : MenuContent
    {
        ...
        public override MenuContentType ContentType
        {
            get
            {
                return MenuContentType.ItemListContent;
            }
        }
        ...
        public override bool UpgradeNotificationActive
        {
            get
            {
                return (GameLogic.Binder.GameState.Player.Notifiers.getNumberOfGreenItemNotifications(this.m_params.ItemType) > 0);
            }
        }
