namespace PlayerView
{
    ...
    public class CrabCharacterAnimator : AbstractCharacterAnimator
    {
        ...
        private void onCharacterRangedAttackStarted(CharacterInstance sourceCharacter, Vector3 targetWorldPt)
        {
            ...
            {
                base.startAction(AbstractCharacterAnimator.Action.ATTACK_RANGED, base.CharacterView.Character.getAttackDuration() * 0.75f, true, -1, -1f);
            }
        }
