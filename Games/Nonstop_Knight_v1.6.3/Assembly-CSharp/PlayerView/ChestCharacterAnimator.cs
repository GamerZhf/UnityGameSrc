namespace PlayerView
{
    ...
    public class ChestCharacterAnimator : AbstractCharacterAnimator
    {
        ...
        protected override Dictionary<AbstractCharacterAnimator.Action, AbstractCharacterAnimator.ActionParameters> getActionClipLinks()
        {
            ...
            string[] textArray2 = new string[] { "IdleTilt" };
            dictionary.Add(AbstractCharacterAnimator.Action.IDLE_ACT, new AbstractCharacterAnimator.ActionParameters(textArray2, 0.1f, 1f, 0f));
            return dictionary;
        }
        ...
        protected override void onUpdate(float dt)
        {
            if (base.CharacterView.IsMenuView)
            {
                ...
                {
                    base.startAction(AbstractCharacterAnimator.Action.IDLE_ACT, 3f, true, -1, -1f);
