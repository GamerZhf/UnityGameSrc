namespace PlayerView
{
    ...
    public class SkeletonCasterRedCharacterAnimator : AbstractCharacterAnimator
    {
        protected override Dictionary<AbstractCharacterAnimator.Action, AbstractCharacterAnimator.ActionParameters> getActionClipLinks()
        {
            ...
            string[] names = new string[] { "RangedAttack1", "RangedAttack2" };
            ...
            string[] textArray2 = new string[] { "SkillBlast" };
            dictionary.Add(AbstractCharacterAnimator.Action.SKILL_BLAST, new AbstractCharacterAnimator.ActionParameters(textArray2, 0.5f, 0.8f, 0f));
            return dictionary;
        }
        ...
        protected override Dictionary<AbstractCharacterAnimator.State, AbstractCharacterAnimator.StateParameters> getStateClipLinks()
        {
            ...
            dictionary.Add(AbstractCharacterAnimator.State.IDLE, new AbstractCharacterAnimator.StateParameters(names, 0.5f));
