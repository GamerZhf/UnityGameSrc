namespace PlayerView
{
    ...
    public class PandaCharacterAnimator : AbstractCharacterAnimator
    {
        protected override Dictionary<AbstractCharacterAnimator.Action, AbstractCharacterAnimator.ActionParameters> getActionClipLinks()
        {
            ...
            dictionary.Add(AbstractCharacterAnimator.Action.ATTACK_MELEE, new AbstractCharacterAnimator.ActionParameters(names, 0.001f, 0.8f, 0f));
            return dictionary;
        }

        protected override AbstractCharacterAnimator.State getMenuViewDefaultState()
        {
            return AbstractCharacterAnimator.State.IDLE_MENU;
        }
        ...
        protected override Dictionary<AbstractCharacterAnimator.State, AbstractCharacterAnimator.StateParameters> getStateClipLinks()
        {
            ...
            dictionary.Add(AbstractCharacterAnimator.State.IDLE, new AbstractCharacterAnimator.StateParameters(names, 0.1f));
            string[] textArray2 = new string[] { "IdleMenu" };
            dictionary.Add(AbstractCharacterAnimator.State.IDLE_MENU, new AbstractCharacterAnimator.StateParameters(textArray2, 0.1f));
            string[] textArray3 = new string[] { "Run" };
            dictionary.Add(AbstractCharacterAnimator.State.RUN, new AbstractCharacterAnimator.StateParameters(textArray3, 0.1f));
            return dictionary;
        }
        ...
        protected override bool onGetTargetAnimationState(out AbstractCharacterAnimator.State state, out float speed)
        {
            ...
            {
                speed = base.CharacterView.Character.MovementSpeed(true) * 0.15f;
