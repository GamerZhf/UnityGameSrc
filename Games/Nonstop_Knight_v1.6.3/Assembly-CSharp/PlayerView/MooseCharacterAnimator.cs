namespace PlayerView
{
    ...
    public class MooseCharacterAnimator : AbstractCharacterAnimator
    {
        ...
        protected override Dictionary<AbstractCharacterAnimator.State, AbstractCharacterAnimator.StateParameters> getStateClipLinks()
        {
            ...
            dictionary.Add(AbstractCharacterAnimator.State.RUN, new AbstractCharacterAnimator.StateParameters(textArray2, 0.1f));
            return dictionary;
        }
        ...
        protected override bool onGetTargetAnimationState(out AbstractCharacterAnimator.State state, out float speed)
        {
            ...
            {
                speed = base.CharacterView.Character.MovementSpeed(true) * 0.11f;
