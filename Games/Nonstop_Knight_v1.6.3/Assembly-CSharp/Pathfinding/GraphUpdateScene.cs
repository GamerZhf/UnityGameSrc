namespace Pathfinding
{
    ...
    [HelpURL("http://arongranberg.com/astar/docs/class_pathfinding_1_1_graph_update_scene.php"), AddComponentMenu("Pathfinding/GraphUpdateScene")]
