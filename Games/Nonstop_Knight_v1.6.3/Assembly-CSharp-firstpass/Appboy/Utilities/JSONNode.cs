namespace Appboy.Utilities
{
    ...
    public class JSONNode
    {
        ...
        public virtual IEnumerable<JSONNode> Childs
        {
            get
            {
                <>c__Iterator0 iterator = new <>c__Iterator0();
                iterator.$PC = -2;
                return iterator;
            }
        }
        ...
        public IEnumerable<JSONNode> DeepChilds
        {
            get
            {
                <>c__Iterator1 iterator = new <>c__Iterator1();
        ...
        [CompilerGenerated]
        private sealed class <>c__Iterator0 : IDisposable, IEnumerable<JSONNode>, IEnumerator<JSONNode>, IEnumerator, IEnumerable
        {
        ...
        [CompilerGenerated]
        private sealed class <>c__Iterator1 : IDisposable, IEnumerable<JSONNode>, IEnumerator<JSONNode>, IEnumerator, IEnumerable
        {
            internal JSONNode $current;
            internal int $PC;
            internal IEnumerator<JSONNode> <$s_11>__0;
            internal IEnumerator<JSONNode> <$s_12>__2;
                ...
                switch (num)
                {
                    case 1:
                        try
                        {
                            ...
                            {
                                if (this.<$s_12>__2 == null)
                                {
                                }
                                this.<$s_12>__2.Dispose();
                            }
                        }
                        finally
                        {
                            if (this.<$s_11>__0 == null)
                            {
                            }
                            this.<$s_11>__0.Dispose();
                        }
                        break;
                }
            }
            ...
            public bool MoveNext()
            {
                ...
                {
                    case 0:
                        this.<$s_11>__0 = this.<>f__this.Childs.GetEnumerator();
                        num = 0xfffffffd;
                        break;
                ...
                try
                {
                    ...
                    while (this.<$s_11>__0.MoveNext())
                    {
                        this.<C>__1 = this.<$s_11>__0.Current;
                        this.<$s_12>__2 = this.<C>__1.DeepChilds.GetEnumerator();
                        num = 0xfffffffd;
                    Label_0077:
                        try
                        {
                            while (this.<$s_12>__2.MoveNext())
                            {
                                this.<D>__3 = this.<$s_12>__2.Current;
            ...
            IEnumerator<JSONNode> IEnumerable<JSONNode>.GetEnumerator()
            {
                ...
                JSONNode.<>c__Iterator1 iterator = new JSONNode.<>c__Iterator1();
